...
public class MenuPrincipal extends JFrame implements ActionListener {
	...
	public MenuPrincipal() {
		...
		JMenuItem mE2 = new JMenuItem("Ajout Echantillons");
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (evt.getSource() instanceof JMenuItem) {
			...
			if (ChoixOption.equals("Consultation Medecin")) {
				...
				ouvrirFenetre(new JIFMedicamentCol(this));
			}
			else if (ChoixOption.equals("Ajout Echantillons")){
	...
	public void ouvrirFenetre(JInternalFrame uneFenetre) {
		...
		myJInternalFrame.setSize(700, 400);
